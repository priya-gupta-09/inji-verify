...
import { getVpRequest, setBankingCredentials, setSelectedClaims } from "../redux/features/verify/vpVerificationState";
...
export function BankingVerify() {
  ...
  return (
    <PageTemplate uploadDisabled={true} scanDisabled={true} vpVerifyDisabled={true} fromComposableBanking={true}>
