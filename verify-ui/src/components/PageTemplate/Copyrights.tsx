...
function Copyrights(props: any) {
    ...
    return (
        <div className={!props.fromComposableBanking?"fixed grid bottom-0 w-[100vw] lg:w-[49vw] content-center justify-center bg-white" : "fixed grid bottom-0 w-[100vw] lg:w-[100vw] content-center justify-center bg-white"}>
